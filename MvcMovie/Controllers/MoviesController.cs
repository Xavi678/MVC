...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        // GET: Movies
        public ActionResult Index(string movieGenre, string searchString, string searchString2)
        {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,ReleaseDate,Genre,Price,IMDB,Cartell,Durada")] Movie movie)
        {
